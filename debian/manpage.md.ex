% libpdfium-dev(SECTION) | User Commands
%
% "July 23 2025"
...
libpdfium-dev - program to do something

# SYNOPSIS

**libpdfium-dev** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**libpdfium-dev** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **libpdfium-dev** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**libpdfium-dev** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    libpdfium-dev. See **foo.conf**(5) for further details.
...
**libpdfium-dev** provides some return codes, that can be used in scripts:
...
Cooper Larson <cooper@valkyrianlabs.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Cooper Larson
